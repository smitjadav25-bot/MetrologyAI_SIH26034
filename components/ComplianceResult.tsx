  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-3 sm:gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-xs text-center">
          <div className={`font-bold text-xl sm:text-2xl ${failedChecks.length > 0 ? 'text-red-600' : 'text-slate-400'}`}>
            {failedChecks.length}
          </div>
          <div className="text-xs font-semibold text-slate-700 mt-0.5">
            Checks Failed
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-xs text-center">
          <div className={`font-bold text-xl sm:text-2xl ${warningChecks.length > 0 ? 'text-amber-600' : 'text-slate-400'}`}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-300 bg-white hover:bg-slate-50 text-xs font-semibold text-slate-700 transition"
            >
            ...
            <Link
              href={verifyUrl}
              target="_blank"
              className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl border border-slate-300 bg-white hover:bg-slate-50 text-xs font-semibold text-slate-700 transition"
            >
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
        ...
        <div className="divide-y divide-slate-100">
          {inspection.ruleResults.map((r, i) => (
            <div key={i} className="px-6 py-3.5 flex items-center justify-between gap-4 text-xs">
              ...
              <div className="text-right">
                ...
                <div className="text-[11px] text-slate-600 font-mono mt-0.5 max-w-[200px] truncate">
                  {r.observedValue}
                </div>
              </div>
            </div>
